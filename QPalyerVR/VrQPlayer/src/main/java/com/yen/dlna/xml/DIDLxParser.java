 ...
 * @author Mario Franco
 */
public class DIDLxParser extends SAXParser {

    final private static Logger log = Logger.getLogger(DIDLxParser.class.getName());
...
//            factory.setNamespaceAware(true);
    ...
    public DIDLContent parse(String xml) throws Exception {
        ...
        Log.d("DD" ,content.toString());
       // Log.d("DD" ,content.getContainers().size());
        int sz= content.getContainers().size();
        Log.d("DD" ,String.valueOf(sz));
        return content;
    }
